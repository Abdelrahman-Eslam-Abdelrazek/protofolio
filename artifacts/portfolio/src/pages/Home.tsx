  ...
  return (
    <div className="preserve-3d" style={{ perspective: "1000px" }}>
      ...
      >
        ...
        {project.id === "06" && (
          <div
            className="absolute top-8 right-8 w-16 h-16 text-ink opacity-10 group-hover:opacity-40 transition-opacity duration-500 pointer-events-none"
        ...
        <div style={{ transform: "translateZ(30px)" }}>
          ...
          <h3 className="font-serif text-xl font-bold text-ink mb-2 relative z-10">
            {project.title}
          </h3>
        ...
        <div style={{ transform: "translateZ(40px)" }}>
          <div className="flex flex-wrap gap-1.5 mb-5">
            {project.tags.map((tag) => (
              <span
                key={tag}
                className="px-2.5 py-1 text-xs font-mono border border-border text-ink-muted bg-white"
              >
                {tag}
              </span>
            ))}
...
export default function Home() {
  ...
  const projects: ProjectProps[] = [
    {
      ...
      title: "EgyRamadan",
      description:
        "Live Arabic movies & series streaming platform with a comprehensive episode database and seamless playback experience.",
    ...
    },
    {
      ...
      title: "StreamSphere",
      description:
        "A modern, highly-responsive movie and series streaming application featuring advanced search and categorization.",
      tags: ["React", "Next.js", "Tailwind CSS"],
      githubLink:
        "https://github.com/Abdelrahman-Eslam-Abdelrazek/StreamSphere",
    },
    {
      id: "03",
      title: "EgyptianTravelEase",
      description:
        "Tourism booking platform equipped with an admin dashboard, real-time chat, and an intelligent car suggestion engine.",
      tags: ["Next.js", "PostgreSQL", "Express"],
      githubLink:
        "https://github.com/Abdelrahman-Eslam-Abdelrazek/EgyptianTravelEase",
    },
    {
      id: "04",
      title: "DarkLeakArchive",
      description:
        "Robust cybersecurity platform hosting a leak archive, community forum, leaderboard system, and integrated chat API.",
      tags: ["Node.js", "Express", "PostgreSQL"],
      githubLink:
        "https://github.com/Abdelrahman-Eslam-Abdelrazek/DarkLeakArchive",
    },
    {
      id: "05",
      title: "ArabicEduPlatform",
      description:
        "Comprehensive online learning management system tailored for delivering high-quality Arabic educational content.",
      tags: ["React", "Next.js", "Supabase"],
      githubLink:
        "https://github.com/Abdelrahman-Eslam-Abdelrazek/ArabicEduPlatform",
    },
    {
      id: "06",
      title: "AI Security Analyzer",
      description:
        "Next-generation tool leveraging machine learning models to scan and detect real-world vulnerabilities in modern web applications.",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section
        id="about"
        className="py-24 md:py-32 bg-off-white relative border-t border-border overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              ...
              <div className="font-sans text-lg text-ink-muted leading-relaxed space-y-6">
                <p>
                  I'm Abdelrahman, a Full-Stack Developer and Web Security
                  Specialist based in Cairo. I don't just build web applications
                  — I harden them.
                </p>
                <p>
                  Currently studying Computer Science at Modern Academy Cairo,
                  I'm combining my development skills with cybersecurity
                  expertise and machine learning to build tools that protect the
                  web.
                </p>
                <p>
                  My next project: an AI-powered security analyzer that detects
                  real vulnerabilities in web applications before they can be
                  exploited.
                </p>
              </div>
            ...
            <ScrollReveal delay={0.2} className="relative">
              ...
              <div className="bg-white border border-ink rounded-sm shadow-deep overflow-hidden">
                <div className="bg-paper border-b border-border px-4 py-3 flex items-center gap-2">
                  ...
                  <div className="w-3 h-3 rounded-full border border-ink/20 bg-ink/10" />
                  <div className="w-3 h-3 rounded-full border border-ink/20 bg-ink/10" />
                  <span className="ml-4 font-mono text-xs text-ink-muted">
                    profile.json
                  </span>
                </div>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none opacity-30 z-0">
          ...
          <div
            className="absolute bottom-40 right-[15%] w-3 h-3 rounded-full bg-border animate-pulse-slow"
            style={{ animationDelay: "1s" }}
          ></div>
          <div className="absolute top-1/3 right-[5%] w-6 h-6 rounded-full border border-border animate-float"></div>
          <div
            className="absolute bottom-20 left-[20%] w-2 h-2 rounded-full bg-ink-faint animate-float"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 md:divide-x divide-border perspective-1000"
          ...
          >
            ...
            <ScrollReveal delay={0.1} className="md:pr-8">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <div
                    key={skill}
                    className="px-4 py-2 font-mono text-sm bg-white border border-ink text-ink transition-all duration-300 hover:bg-ink hover:text-white transform hover:-translate-y-1 hover:translate-z-8 hover:scale-105 hover:shadow-soft cursor-default"
                  >
                    {skill}
                  </div>
                ))}
            ...
            <ScrollReveal delay={0.2} className="md:px-8">
              ...
              <div className="flex flex-wrap gap-3">
                {["Node.js", "Express", "PostgreSQL", "Supabase", "Python"].map(
                  (skill) => (
                    <div
                      key={skill}
                      className="px-4 py-2 font-mono text-sm bg-white border border-ink text-ink transition-all duration-300 hover:bg-ink hover:text-white transform hover:-translate-y-1 hover:translate-z-8 hover:scale-105 hover:shadow-soft cursor-default"
      ...
      <section
        id="projects"
        className="py-16 md:py-24 bg-off-white border-t border-border relative overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="font-mono text-xs tracking-widest text-ink-muted uppercase mb-3">
              Selected Work
            </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="font-mono text-sm tracking-widest text-ink-muted uppercase mb-4 text-center">
              Credentials
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[
              {
                title: "Penetration Testing, Incident Response & Forensics",
                issuer: "Coursera",
                date: "Sep 2023",
              },
              {
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 text-center">
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 mb-20">
              <a
                href="mailto:abdo722005eslam@gmail.com"
                className="flex items-center gap-3 font-sans text-lg text-white hover:text-white/70 transition-colors group"
              >
            ...
            <div className="flex justify-center gap-6 mb-24">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-14 h-14 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-ink transition-all transform hover:-translate-y-1"
              >
                <Github size={24} />
              </a>
              <a
                href="#"
                className="w-14 h-14 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-ink transition-all transform hover:-translate-y-1 font-serif font-bold text-xl italic"
              >
                f
              </a>
              <a
                href="#"
                className="w-14 h-14 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-ink transition-all transform hover:-translate-y-1 font-serif font-bold text-xl"
              >
                ig
              </a>
            </div>
        ...
        <div className="absolute bottom-6 left-0 right-0 text-center font-mono text-xs text-white/40">
          © {new Date().getFullYear()} Abdelrahman Eslam Abdelrazek — Designed &
          Built in Cairo 🇪🇬
        </div>
      </section>
    </div>
